...
from generator.simplify import join_contracts_by_conjunction
...
def print_final_contracts(contracts, target):
    print(f'======== {"\033[31m"}Final Contracts for Method {target}{"\033[36m"} =============')
    for c in contracts:
        print(c)
...
def generate(A: Automaton, target_method):
    ...
    print_final_contracts(final_contracts, target)
